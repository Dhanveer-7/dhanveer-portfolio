      ...
      <div className="section-container hero-content">
        ...
        <div className="stats-strip" style={{ display: 'flex', justifyContent: 'center', gap: '2rem', margin: '2.5rem auto 3rem', flexWrap: 'wrap', maxWidth: '800px' }}>
          ...
          <div style={{ padding: '0.5rem 1.5rem', textAlign: 'center', flex: '1 1 120px', borderLeft: '1px solid var(--border-color)' }} className="stat-border-left">
            <div style={{ fontSize: '2.25rem', fontWeight: '800', color: 'var(--primary-color)' }}>7</div>
          ...
          <div style={{ padding: '0.5rem 1.5rem', textAlign: 'center', flex: '1 1 120px', borderLeft: '1px solid var(--border-color)' }} className="stat-border-left">
            <div style={{ fontSize: '2.25rem', fontWeight: '800', color: 'var(--primary-color)' }}>2</div>
            <div style={{ fontSize: '0.8rem', color: 'var(--text-secondary)', fontWeight: '700', textTransform: 'uppercase', letterSpacing: '0.05em', marginTop: '0.2rem' }}>Hackathon Honors</div>
          </div>
        </div>
